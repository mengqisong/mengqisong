...
public class GenEntityOracle {
    ...
    private String authorName = "wanghd";// ��������
    private String tablename = "eb_brand";// ����
    private String packageOutPath = "main.java.com.mqs.entity";// ָ��ʵ���������ڰ���·��
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/zhoukao?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        //�������Ǳ���  ���ɵ�ʵ������ĸ��д   ������User
    	//��һ����������    �ڶ�������ʵ������    �������������ݿ�����
        new GenEntityOracle("dianying","Dianying","zhoukao").init();  
        new GenEntityOracle("type","Type","zhoukao").init();  
    }  
}